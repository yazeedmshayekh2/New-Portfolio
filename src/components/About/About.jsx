  ...
  return (
    <section className="about" id="about">
      <div className="about-container" ref={ref}>
        <h2
          className={`section-title animate-blur ${isVisible ? "visible" : ""}`}
        >
        ...
        <div className="about-grid">
          <div
            className={`about-text animate-slide-left delay-1 ${isVisible ? "visible" : ""}`}
          >
          ...
          <div className="about-stats">
            ...
            <div
              className={`about-languages animate-on-scroll delay-6 ${isVisible ? "visible" : ""}`}
            >
